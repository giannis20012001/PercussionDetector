    ...
    public UDPServer() {
        ...
        try (DatagramSocket serverSocket = new DatagramSocket(9003)) {
            while (true) {
                ...
                System.out.println("Received from client: [" + message + "] From: " + receivePacket.getAddress());
                System.out.println("Received from client: [" + message.trim() + "] From: " + receivePacket.getAddress());
